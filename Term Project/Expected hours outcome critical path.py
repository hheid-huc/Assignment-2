...
# Print the results that identify tasks that start at time 0 (tasks that are at the beginning of the project) and then finds the maximum end time among these tasks
